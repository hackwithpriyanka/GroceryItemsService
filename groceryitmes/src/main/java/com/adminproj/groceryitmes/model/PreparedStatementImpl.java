...
import java.util.Calendar;
	...
	public class PreparedStatementImpl implements PreparedStatement{
	    ...
	    protected PreparedStatement getCountPreparedStatement() {
	        return countPreparedStatement;
	    }
	    ...
	    public PreparedStatementImpl(PreparedStatement preparedStatement,PreparedStatement countPreparedStatement ) {
	        this.preparedStatement = preparedStatement;
	        this.countPreparedStatement = countPreparedStatement;
	    }
	    ...
	    public int executeCountQuery() throws SQLException {
	        int count=0;
